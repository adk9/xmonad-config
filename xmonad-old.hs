...
--
myWorkspaces = ["1:term","2:code","3:web","4:comm","5:irc"] ++ map show [6..9]
...
showCurrentWS :: X ()
showCurrentWS = withWindowSet (D.dzenConfig (onCurr (center 100 100) >=> font "-*-terminus-bold-*-*-*-24-*-*-*-*-*-*-*" >=> D.timeout 1) . W.currentTag)
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Cycle workspaces
  -- With DynamicWindows
  , ((modMask .|. controlMask, xK_Right), rotView True >> showCurrentWS)
  , ((modMask .|. controlMask, xK_Left), rotView False >> showCurrentWS)
  , ((modMask .|. controlMask, xK_Down), nextScreen >> showCurrentWS)
  , ((modMask .|. controlMask, xK_Up), prevScreen >> showCurrentWS)
  ]
  ++
